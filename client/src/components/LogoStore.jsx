...
export function LogoStore() {
  return (
    <div className="relative flex flex-col items-center scale-70 md:scale-75 group">
      <img 
        src={cascoLogo} 
        alt="logo" 
        className="h-16 group-hover:animate-slide transform transition-transform duration-500" 
      />
